...
class AttendanceCharV2 extends StatefulWidget {
  const AttendanceCharV2({super.key});

  @override
  State<AttendanceCharV2> createState() => _AttendanceCharV2State();
}

class _AttendanceCharV2State extends State<AttendanceCharV2> {
  ...
  Widget buildPieChart() {
    ...
    int total = totalAsistencias + totalPermisions + totalFaltas;
          ...
          Column(
            ...
            children: [
              ...
              _buildLegendRow(
                color: blueColor,
                label: 'Total',
                value: totalAsistencias + totalPermisions + totalFaltas,
              ),
            ],
          ),
        ],
